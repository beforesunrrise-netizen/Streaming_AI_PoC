...
def run_workflow(
    ...
    logger.info(f"[Workflow] Starting workflow for query: {user_query[:50]}...")
    ...
    logger.info(f"[Workflow] Completed. Answer generated: {final_state.get('answer_generated', False)}")
